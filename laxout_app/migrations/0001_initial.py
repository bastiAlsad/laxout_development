    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2024, 2, 18, 16, 36, 42, 351166))),
            ],
        ),
        migrations.CreateModel(
            name='DoneWorkouts',
            fields=[
                ...
                ('laxout_user_id', models.IntegerField(default=0)),
                ('date', models.DateTimeField(default=datetime.datetime(2024, 2, 18, 16, 36, 42, 351165))),
            ],
        ),
        migrations.CreateModel(
            name='First',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_week', models.IntegerField(default=7)),
                ('created_by', models.IntegerField(blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateField(default=datetime.datetime(2024, 2, 18, 15, 36, 42, 353166, tzinfo=datetime.timezone.utc))),
                ...
                ('last_meet', models.DateField(default=datetime.datetime(2024, 2, 18, 16, 36, 42, 353167))),
                ('instruction', models.CharField(default='', max_length=200)),
