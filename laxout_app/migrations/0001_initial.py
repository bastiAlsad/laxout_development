    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2023, 12, 28, 18, 52, 27, 423247))),
            ],
        ),
        migrations.CreateModel(
            name='DoneWorkouts',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.IntegerField(default=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_month', models.IntegerField(default=12)),
                ('created_by', models.IntegerField(blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_uid', models.CharField(default='80aa095d-74ac-4a85-ae57-e17e874ff2d7', max_length=420, unique=True)),
                ...
                ('creation_date', models.DateField(default=datetime.datetime(2023, 12, 28, 17, 52, 27, 424246, tzinfo=datetime.timezone.utc))),
                ...
                ('last_meet', models.DateField(default=datetime.datetime(2023, 12, 28, 18, 52, 27, 424246))),
                ('instruction', models.CharField(default='', max_length=200)),
